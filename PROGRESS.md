...
| USP | ✅ | node 579:10031 (SSM) / node 708:20799 (SFB) | packages/ui/src/components/usp/usp.tsx | variant prop added 2026-05-21. variant="ssm": Futura PT Heavy 900, tracking -0.019em, desktop leading-[28px]. variant="default" (all other sites): Helvetica Neue Bold 700, tracking 0.1px mobile / 0 desktop, desktop leading-8. All SSM pages pass variant="ssm". |
