...
| SfbetsFooter | ✅ | node 962:6297 (NJ), 1124:14012 (MI) | packages/ui/src/components/sfbets-footer/sfbets-footer.tsx | NJ state footer. 4 nav links. 3 NJ logos in grid-cols-3 desktop / grid-cols-1 mobile, each with description below: 21+, NJ DGE seal, rg-nj. Multi-state helpline legal text + NJ copyright. Logo files at /sfbets/footer/. Figma note: PA + WV copyright lines say "MI" — fix before building those states. |
