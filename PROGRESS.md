...
| OfferCard | ✅ | node 549:11989 | packages/ui/src/components/OfferCard/OfferCard.tsx | 2 responsive variants (mobile/desktop); uses Label + Button. Mobile: offer text LEFT (1fr), logo RIGHT (144px). Desktop: offer+checkmarks LEFT (flex-1), logo MIDDLE (224px), button group RIGHT (253px); py-6 px-5 padding. Desktop checkmarks gap-3 (12px). Both variants: PLAY NOW (primary) + optional "How To Claim" (text link, underline) stacked. New props: secondaryCtaText + secondaryCtaHref. Updated 2026-05-06. |
