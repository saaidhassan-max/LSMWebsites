...
| LogoSection | ✅ | node 583:12161 | packages/ui/src/components/logo-section/logo-section.tsx | Responsive header bar. Both breakpoints: invisible spacer LEFT, SSMLogo CENTER, menu button RIGHT (no order swap needed). Mobile (40px): SSMLogo 45×45, tertiary Menu icon 24px. Desktop (72px): SSMLogo 84×84, button reads "Menu" label then icon 32px (text before icon). Background image updated to Lego_Deco2.png. onMenuClick + src props; Storybook story included. Updated 2026-05-11. |
