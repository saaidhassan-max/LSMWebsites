...
export interface CasinoPageData {
  ...
  ctaText: string;
  ctaHref: string;
  reviewBody: string;           // mobile: single text block
  reviewIntro?: string;         // desktop: bold intro paragraph
  reviewSections?: ReviewSection[]; // desktop: 2-col structured sections
}
...
const CASINOS: Record<string, CasinoPageData> = {
  '888poker': {
    ...
    howToSteps: [
      '1. Click here to go to 888 Poker!',
      '2. Sign up and create your account',
      '3. Get 10 free spins – no deposit needed',
    ...
    reviewIntro: 'Placeholder intro — replace with real casino review copy. This bold paragraph introduces the casino and appears at the top of the desktop review section.',
    reviewSections: [
      {
