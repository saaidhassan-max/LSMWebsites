...
const INTRO = `At Super Free Bets, our goal is to provide Michigan players with a superior online casino gaming experience.
...
const SAFE = {
    heading: 'Secure, Safe Michigan Online Casino Gaming',
    body: `You will always be in safe hands when you play with our partners. All the casinos we work with are legal and licensed to operate online in Michigan. We only connect you with the licensed casino brands that we know and love, to eliminate any risk for you. These are just a few of the advantages of choosing us for your Michigan online casino experiences:`
};
...
const ACCURATE = {
    heading: 'Accurate, Up-to-Date Information for Online Casinos in Michigan',
    body: `For everyone who wants to learn more about internet gambling in the Great Lakes State, the various types of bonus offers available or other details about online casino gaming, we have accurate, up-to-date information right here on our site.\n\nWe have step-by-step bonus claim guides, unbiased Michigan casino reviews, the latest internet gambling industry news and descriptions of the hottest games – all that, plus the best free cash and deposit match offers currently available.`
};

const CLOSING = {
    heading: 'We Are Always Here for You!',
    body: `Super Free Bets is here to meet your needs, and we hope to become your one and only source for everything related to Michigan online casino gaming. Feeling lucky? Check out our bonus offers and get started playing today!`
};
