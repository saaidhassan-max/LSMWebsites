            ...
            <section className="w-full max-w-[1440px] mx-auto px-4 py-8 md:px-16 md:py-12">
                <div className="flex flex-col gap-8 md:max-w-[948px] text-on-surface-light">
                    ...
                    <Section title="SMS Marketing Terms:">
                        <ul className="list-disc list-inside flex flex-col gap-2 pl-4 text-base leading-6 tracking-[0.5px]">
                            <li>You should expect to receive up to 4 SMS marketing messages from Super Free Bets per week.</li>
                            <li>Text STOP to +12312611337 to stop receiving our SMS messages. You will no longer receive text messages from Super Free Bets.</li>
                            <li>Alternatively, you may opt-out of receiving our SMS messages at any time by contacting our customer care team at: support@superfreebets.com.</li>
                            <li>We do not charge to send our SMS marketing messages to you however, some carriers may charge you standard message rates and data charges to receive your text messages or reply to them. Please check with your cell phone carrier for further details of any charges that will apply to you.</li>
                            <li>
                                The following text commands are available: -
                                <ul className="list-disc list-inside flex flex-col gap-1 pl-4 mt-1">
                                    <li>STOP: At any time, you can text STOP to +12312611337. This will prevent you from receiving any future texts from Super Free Bets.</li>
                                    <li>HELP: At any time, you can text HELP to +12312611337.</li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <Section title="Email Marketing Terms:">
                        <ul className="list-disc list-inside flex flex-col gap-2 pl-4 text-base leading-6 tracking-[0.5px]">
                            <li>You should expect to receive up to 4 emails from Super Free Bets per week.</li>
                            <li>You may opt out of receiving our emails by clicking on the unsubscribe link in our mailers or by sending &apos;unsubscribe&apos; to: support@superfreebets.com.</li>
                            <li>Should you require any support with opting out of our emails or with any other issues please contact our customer care team at: support@superfreebets.com.</li>
                        </ul>
                    </Section>
