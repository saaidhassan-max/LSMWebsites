...
const UNSUBSCRIBE_TEXT = `If you have subscribed to emails from Super Free Slot Games and would like to stop receiving these, you can unsubscribe at any time by scrolling to the bottom of the email and clicking 'Unsubscribe from future emails'.
...
If you need further assistance unsubscribing from our email and/or SMS updates, you can also contact us at support@superfreeslotgames.co.uk.
Please note that as Super Free Slot Games is purely a comparison site, we do not have access to any accounts you may have set up when clicking through to individual casinos. In order to make changes to these accounts, please contact the customer service team for the site you signed up to.`;
...
const RESPONSIBLE_GAMBLING_LOGOS: RgLogo[] = [
    { src: '/sfsg/footer/keepitfun.svg', alt: 'Keep It Fun', width: 176, height: 39 },
    { src: '/sfsg/footer/18plus.svg', alt: '18+', width: 52, height: 52 },
    { src: '/sfsg/footer/gamcare.svg', alt: 'GamCare', width: 176, height: 50 },
    { src: '/sfsg/footer/gamstop.svg', alt: 'GAMSTOP', width: 70, height: 52 },
    { src: '/sfsg/footer/gambleaware.svg', alt: 'GambleAware', width: 176, height: 23 },
    { src: '/sfsg/footer/gamblingtherapy.svg', alt: 'Gambling Therapy', width: 137, height: 52 }
];
