...
import { ScrollFocusOfferList } from '../../components/scroll-focus-offer-list';
import { categoryOffers } from '../../data/category-offers';
import { getCmsSiteSettings } from '../../data/cms-content';

export const metadata: Metadata = {
    title: 'No Deposit Bingo Offers | Super Free Bingo',
    description:
        'Compare the latest no deposit bingo offers, free spins and welcome bonuses from UK licensed bingo sites.'
};

export default async function NoDepositBingoPage(): Promise<React.ReactElement> {
    ...
    return (
        <main className="flex w-full flex-col bg-surface">
            ...
            <ScrollFocusOfferList offers={categoryOffers} />
