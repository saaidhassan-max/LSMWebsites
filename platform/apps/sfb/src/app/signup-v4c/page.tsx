...
import { SignupLandingPageV4C } from '../../components/signup-landing-page-v4c';
...
export default async function SignupV4CPage(): Promise<React.ReactElement> {
    const settings = await getCmsSiteSettings();
    return (
        <SignupLandingPageV4C
