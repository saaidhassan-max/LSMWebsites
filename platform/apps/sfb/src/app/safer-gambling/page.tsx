...
const UNSUBSCRIBE_TEXT = `If you have subscribed to emails from Super Free Bingo and would like to stop receiving these, you can unsubscribe at any time by scrolling to the bottom of the email and clicking 'Unsubscribe from future emails'.
...
If you need further assistance unsubscribing from our email and/or SMS updates, you can also contact us at support@superfreebingo.co.uk.
Please note that as Super Free Bingo is purely a comparison site, we do not have access to any accounts you may have set up when clicking through to individual bingo sites. In order to make changes to these accounts, please contact the customer service team for the site you signed up to.`;
...
const EXTERNAL_SUPPORT: SupportOrg[] = [
    {
        ...
        body: 'GamCare is the leading provider of free information, advice, and support for anyone affected by problem gambling in Great Britain. You can reach them via their helpline, live chat, or forum.'
    },
    {
        title: 'BeGambleAware',
        url: 'www.begambleaware.org',
        href: 'https://www.begambleaware.org',
        body: 'BeGambleAware aims to keep gambling safe and fun by providing information, advice, and support to people affected by problem gambling across the UK.'
    },
    {
        title: 'GamStop',
        url: 'www.gamstop.co.uk',
        href: 'https://www.gamstop.co.uk',
        body: 'GamStop is a free service that lets you put controls in place to restrict your online gambling activities across UK-licensed gambling websites and apps.'
    },
    {
        title: 'Gambling Therapy',
        url: 'www.gamblingtherapy.org',
        href: 'https://www.gamblingtherapy.org',
        body: 'Gambling Therapy is a global online service that offers free practical advice and emotional support to anyone affected by problem gambling.'
    },
    {
        title: 'National Gambling Helpline',
        url: '0808 8020 133',
        href: 'tel:08088020133',
        body: 'The National Gambling Helpline is free, confidential, and available 24 hours a day, 7 days a week. Call 0808 8020 133 for advice and support.'
    }
];
...
const RESPONSIBLE_GAMBLING_LOGOS: RgLogo[] = [
    { src: '/sfb/footer/keepitfun.svg', alt: 'Keep It Fun', width: 176, height: 39 },
    { src: '/sfb/footer/18plus.svg', alt: '18+', width: 52, height: 52 },
    { src: '/sfb/footer/gamcare.svg', alt: 'GamCare', width: 176, height: 50 },
    { src: '/sfb/footer/gamstop.svg', alt: 'GAMSTOP', width: 70, height: 52 },
    { src: '/sfb/footer/gambleaware.svg', alt: 'GambleAware', width: 176, height: 23 },
