...
import { SignupLandingPageV4B } from '../../components/signup-landing-page-v4b';
...
export default async function SignupV4BPage(): Promise<React.ReactElement> {
    const settings = await getCmsSiteSettings();
    return (
        <SignupLandingPageV4B
