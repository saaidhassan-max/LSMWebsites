...
export const homeOffers: OfferCardProps[] = [
    {
    ...
    {
        showLabel: false,
        logoSrc: '/sfb/brands/sunvegas.png',
        logoAlt: 'The Sun Vegas',
        ...
        ctaHref: '#',
        termsText:
            '18+. New customers only. Register today to receive 10 free spins, plus deposit & spend £10 to receive 100 free spins. Free spins must be accepted within 48 hours and are playable on selected games only. 0 x wagering on winnings from 10 free spins. 10x wagering on winnings from 100 free spins. All free spins are valid for 3 days. Debit cards only. Offer Ends 31.07.26. T&Cs Apply. GamCare.org.uk. GambleAware.org.'
    },
    {
        showLabel: false,
    ...
    {
        showLabel: false,
        logoSrc: '/sfb/brands/buzzbingo.png',
        logoAlt: 'Buzz Bingo',
        offerMain: '10 Free Spins',
        details: [
            { emoji: '✅', text: 'No Deposit' }
        ...
        ctaHref: '#',
        termsText:
            '18+. Register for first time successfully online at buzzbingo.com as new player. No deposit required. Get £2.00 (10 x 20p) Rainbow Riches slot bonus. 10x wagering requirements on bonus. 90 day expiry. Full T&Cs apply. GambleAware.org.'
    },
    {
        label: 'FOR A FIVER',
        labelColor: 'blue',
    ...
    },
    {
        ...
        ctaHref: '#',
        termsText:
            '18+. New customers only. Register today to receive 10 Free Spins (accept within 48 hours & wager winnings 10x within 3 days). Debit cards only. Offer Ends 31.07.26. T&Cs Apply. GamCare.org.uk. GambleAware.org.'
    },
    {
    ...
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/sunbingo.png',
        logoAlt: 'The Sun Bingo',
        offerMain: '£10 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'No Deposit' }
        ],
        ctaText: 'CLICK TO CLAIM',
        ctaHref: '#',
        termsText:
            '18+. New Customers only. Register today to receive £10 Bingo Bonus (accept & wager bonus 8x within 48 hours). Deposit and spend a minimum of £10 to receive a £40 Bingo Bonus (accept & wager bonus 4x within 7 days). Only completed games are credited. Debit cards only. Offer ends 31.07.26. T&Cs Apply. GamCare.org.uk. GambleAware.org.'
    },
    {
        showLabel: false,
    ...
    {
        label: 'USE CODE: WOOL100',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/winkbingo.png',
        logoAlt: 'Wink Bingo',
        offerMain: '100 Free Spins',
        details: [
            { emoji: '✅', text: 'Deposit: £10' }
        ...
        ctaHref: '#',
        termsText:
            '18+. New players only. Min dep £10. Free Spin value 5p. Wins paid to games bonus. 10x games bonus wagering required. 5-day expiry. GamCare.org  T&Cs apply. GambleAware.org.'
    },
    {
        label: 'KEEP WHAT YOU WIN',
        labelColor: 'blue',
    ...
    },
    {
        ...
        logoSrc: '/sfb/brands/befaircasino.png',
        logoAlt: 'Betfair Casino',
        offerMain: 'Up to 300 Free Spins',
        details: [
            { emoji: '✅', text: 'Spend: £10+' },
            { emoji: '✅', text: 'No Wagering' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. New customers only. Up to 300 spins over 3 day period from first deposit & spend of £10. Max 100 spins each day on Fishin\' BIGGER Pots of Gold at 10p per spin for 3 consecutive days. Deposit & spend £10 each day for 100 spins. Spins credited upon spend of £10 each day. 18+. Full T&Cs apply. GambleAware.org.'
    },
    {
    ...
    },
    {
        ...
        logoAlt: 'Megaways Casino',
        offerMain: 'Up to £120 Bonus',
        details: [
            { emoji: '✅', text: '+ 50 Free Spins' },
            { emoji: '✅', text: 'Deposit: £10' }
        ],
        ctaText: 'CLICK TO CLAIM',
        ctaHref: '#',
        termsText:
            '18+. First Deposit Only. Min. deposit: £10, max. Bonus £120. Game: Fishing Frenzy Big Catch Megaways, Spin Value: £0.10, Max Free Spins: 50. WR of 10x Bonus amount and Free Spin winnings amount (only Slots count) within 30 days. Max bet is 10% (min £0.10) of the free spin winnings and bonus amount or £5 (lowest amount applies). Free Spins must be used before deposited funds. This offer is only available for specific players that have been selected by Megaways Casino. If you have arrived on this page not via the designated offer via Megaways Casino you will not be eligible for the offer. Spins must be used and/or Bonus must be claimed before using deposited funds. Deposit/Welcome Bonus can only be claimed once every 72 hours across all Casinos. Bonus Policy applies. GambleAware.org.'
    },
    {
        showLabel: false,
    ...
    {
        label: 'USE CODE: PINTV6',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/paddypowersbingo.png',
        logoAlt: 'Paddy Power Bingo',
        offerMain: '£60 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. New players only. Deposit and spend £10 to get £60 bonus. Deposit and spend £10 on bingo tickets within 30 days of joining Paddy Power Bingo using a valid debit card, Pay by Bank, or Apple Pay. 1/customer. Get £60 paid as Bingo Bonus (1x wagering requirement) when you register via the code PINTV6. Full T&Cs apply. GambleAware.org.'
    },
    {
        label: 'EXCLUSIVE',
        labelColor: 'blue',
    ...
    {
        label: 'USE CODE: BINW50',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/betfairbingo.png',
        logoAlt: 'Betfair Bingo',
        offerMain: '£60 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. Reg Code: BINW50. Play £10 on Bingo tickets. Full T&Cs apply. GambleAware.org.'
    },
    {
        label: 'KEEP WHAT YOU WIN',
        labelColor: 'blue',
    ...
    },
    {
        ...
        ctaHref: '#',
        termsText:
            '18+. New Players Only. 10x Wagering in 7 days. Qualifying Deposit played first. Max Bet £5. Bonus Cash to be used on Bingo only. Max Win £200. Terms & Conditions Apply. GambleAware.org.'
    },
    {
        label: 'EXCLUSIVE',
        labelColor: 'blue',
    ...
    {
        showLabel: false,
        logoSrc: '/sfb/brands/skybingo.png',
        logoAlt: 'Sky Bingo',
        offerMain: '£20 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ...
        ctaHref: '#',
        termsText:
            '18+. New customers only. 30 day qualification period. 30 day bonus expiry. Bonus non-withdrawable, winnings paid in cash. Game & eligibility restrictions apply. Further T&C\'s apply. GambleAware.org.'
    },
    {
        label: 'KEEP WHAT YOU WIN',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'PlayOJO',
        offerMain: '500 Bingo Tickets',
        details: [
            { emoji: '✅', text: '+ 80 Free Spins' },
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ctaText: 'CLICK TO CLAIM',
        ctaHref: '#',
        termsText:
            '18+. First deposit only. Min deposit £10. 500 free bingo tickets when you spend £10 on Bingo, mini games excluded, see bingo rooms for info.  80 Free Spins on Big Bass Bonanza. Spin Value: £_0.10. Excl. new players in N.I. This offer is only available for specific players that have been selected by PlayOJO. If you have arrived on this page not via the designated offer via PlayOJO you will not be eligible for the offer. Irregular play may lead to removal of reward. Rewards and Game Play Policy applies. GambleAware.org.'
    },
    {
        label: 'KEEP WHAT YOU WIN',
        labelColor: 'blue',
        ...
        ctaHref: '#',
        termsText:
            '18+. New Casino players only. 50 Free Spins (£0.10 each, selected games only, valid 7 days) awarded upon registration. For additional 150 Free Spins (£0.10 each, selected games only, valid 7 days) deposit (certain deposit types excluded) and bet £10+ on any Slot games within 30 days of registration. Restrictions and T&Cs apply. GambleAware.org.'
    },
    {
        label: 'EXCLUSIVE',
        labelColor: 'blue',
    ...
    {
        showLabel: false,
        logoSrc: '/sfb/brands/betmgm.png',
        logoAlt: 'BetMGM',
        offerMain: '200 Free Spins',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ctaText: 'CLICK TO CLAIM',
        ctaHref: '#',
        termsText:
            '18+. New cust only. Opt-in required. Time to deposit/wager 7 days. Deposit £10 & wager 1x on casino games (wagering contributions vary) for 200 Free Spins worth 10p each on Big Bass Splash. 3 day reward expiry. T&Cs apply. GambleAware.org'
    },
    {
        label: 'MOST FREE SPINS',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'Lottomart Games',
        offerMain: 'Up to 500 Free Spins',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. New players only. Opt-in required. Min. £10 cash stakes on slots to qualify. Prize Wheel must be used & Free Spins claimed within 4 days. Free Spins must be played within 24 hours of claim. Free Spin winnings credited as cash. Max 1x claim. Full prize list in main terms. Further T&Cs apply. GambleAware.org.'
    },
    {
        label: 'FOR A FIVER',
        labelColor: 'blue',
    ...
    {
        showLabel: false,
        logoSrc: '/sfb/brands/leovegas.png',
        logoAlt: 'LeoVegas',
        offerMain: '50 Free Spins',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ...
        ctaHref: '#',
        termsText:
            '18+. New cust only. Opt in, deposit £10+ within 7 days of registering & wager 1x on eligible casino games within 7 days to get 50 Wager-Free Free Spins on Big Bass Splash. 3 day expiry. Wagering contributions vary. T&Cs & exclusions apply. GambleAware.org.'
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/kittybingo.png',
        logoAlt: 'Kitty Bingo',
        offerMain: '£35 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'Spend: £10' }
        ],
        ctaText: 'CLICK TO CLAIM',
    ...
    },
    {
        label: 'USE CODE: V26',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/williamhill.png',
        ...
        ctaHref: '#',
        termsText:
            '18+. Play Safe. Online only. For new UK registered players. Runs this month. Register with code V26 and opt in via the promo page to receive a £20 bonus for use on the promotion game. Bonus valid for 72h and subject to x10 wagering, which must be completed on the promo game within that 72h. Max redeemable winnings - £25. One per player. Ts&Cs apply. GambleAware.org. #ad'
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/freespinsbingo.png',
        logoAlt: 'Free Spins Bingo',
        offerMain: 'Up to 500 Free Spins',
        details: [
            { emoji: '✅', text: 'Deposit: £10' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. New players only, £10+ fund, 10x bonus wagering requirements, max bonus conversion to real funds equal to lifetime deposits (up to £250), Full T&Cs apply. GambleAware.org.'
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/dailyrecordbingo.png',
        logoAlt: 'Daily Record Bingo',
        offerMain: '100% Bonus',
        details: [
            { emoji: '✅', text: 'Across Your First 3 Deposits' },
            { emoji: '✅', text: 'Up to £600' },
            { emoji: '✅', text: 'Deposit: £10' }
        ],
        ctaText: 'CLICK TO CLAIM',
        ctaHref: '#',
        termsText:
            '18+. New players only, £10 min fund, £600 (£200 x 3) max bonus on your first 3 deposits, 10x Bonus wagering requirements, max bonus conversion to real funds equal to lifetime deposits (up to £250). Full T&Cs apply. GambleAware.org.'
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/okbingo.png',
        logoAlt: 'OK! Bingo',
        offerMain: '100% Bonus',
        details: [
            { emoji: '✅', text: 'Deposit: £10' }
        ...
        ctaHref: '#',
        termsText:
            '18+. New players only, £10 min fund, £150 max bonus, 10x Bonus wagering requirements, max bonus conversion to real funds equal to lifetime deposits (up to £250). Full T&Cs apply. GambleAware.org.'
    },
    {
        showLabel: false,
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'Monster Casino',
        offerMain: '£40 Bingo Bonus',
        details: [
            { emoji: '✅', text: 'Deposit: £10' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. New Players Only. Wager from real balance first. 2X wager the bonus on Bingo games. The wagering requirement is calculated on bonus bets only. Bonus valid 30 days from receipt. Max conversion: £40. Min Deposit £10 required. Withdrawal requests void all active/pending bonuses. Excluded Skrill and Neteller deposits. Full Terms Apply. GambleAware.org.'
    },
    {
        label: 'KEEP WHAT YOU WIN',
        labelColor: 'blue',
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'kwiff Casino',
        offerMain: '200 Free Spins',
        details: [
            { emoji: '✅', text: 'Spend: £20' }
        ],
        ...
        ctaHref: '#',
        termsText:
            '18+. Wager £20 cash on slots within 5 days of first deposit and Get 200 Free Spins on Book of Dead. £0.10 per spin. £250 total max withdrawal. E-wallets and virtual cards excluded. New customers only. Full T&Cs apply. Gamble Responsibly. GambleAware.org.'
    }
];
