...
export const categoryOffers: OfferCardProps[] = [
    {
        label: 'NO DEPOSIT',
        labelColor: 'orange',
    ...
    },
    {
        ...
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'Gala Bingo',
        offerMain: '300% BINGO BONUS + 30 FREE SPINS',
        details: [
    ...
    },
    {
        ...
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'Sun Bingo',
        offerMain: '£50 BINGO BONUS + £10 SLOTS BONUS',
        details: [
            { emoji: '💳', text: 'Spend £10' },
    ...
    },
    {
        ...
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'Heart Bingo',
        offerMain: '£60 BONUS + 60 FREE SPINS',
        details: [
            { emoji: '💳', text: 'Spend £10' },
    ...
    },
    {
        ...
        labelColor: 'orange',
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'tombola bingo',
        offerMain: '£20 FREE BINGO',
        details: [
            { emoji: '💳', text: 'Deposit £10' },
    ...
    },
    {
        ...
        labelColor: 'red',
        logoSrc: '/sfb/brands/placeholder.png',
        logoAlt: 'William Hill Bingo',
        offerMain: '£50 BINGO BONUS',
        details: [
            { emoji: '💳', text: 'Spend £10' },
            { emoji: '🎁', text: '£50 Bonus' }
        ],
