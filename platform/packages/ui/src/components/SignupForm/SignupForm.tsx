...
export function SignupForm({
  ...
  return (
    <div className="w-full rounded-lg overflow-hidden">
      ...
      {/* Form body — bg-outline (dark gray) */}
      <form onSubmit={handleSubmit} className="bg-outline p-3 flex flex-col gap-6">
        ...
        <div className="flex flex-col">
          <p className="text-on-surface-light text-[11px] leading-[13px] tracking-[0.4px]">
            By checking the box below, you confirm that you are of legal gambling age in your
            province and have not self-excluded from any gambling operator.
          </p>
          ...
          <p className="text-on-surface-light text-[11px] leading-[13px] tracking-[0.4px]">
            These emails will include information, news, and updates about online casinos and
            sportsbooks, as well as promotional content related to eCommerce offerings. Email
            frequency may vary. You can unsubscribe at any time by clicking the link in our
            emails.{' '}
