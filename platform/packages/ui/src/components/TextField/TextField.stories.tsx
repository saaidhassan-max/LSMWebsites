  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <TextField label="Email" icon={Mail} value={value} onChange={(e) => setValue(e.target.value)} onClear={() => setValue('')} />
        <TextField label="Email" icon={Mail} value="youremail!gmail.com" error="Please enter a valid email address" />
